	...
	<div id="content">
		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<p>Du akzeptierst automatisch die <a target="_blank" href="/regeln">Grunds&auml;tze /-regeln</a> sobald Du auf "Registrierung abschlie&szlig;en" klickst.</p>
