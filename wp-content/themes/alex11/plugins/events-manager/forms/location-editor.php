		...
		<div class="inside">
			...
			<div id="em-location-data">
				<table>
					...
					<tr>
						<th><?php _e ( 'Details', 'dbem' ); ?>:</th>
						<td><textarea name="content"><?php echo $EM_Location->description; ?></textarea></td>
					</tr>
				</table>
				<?php if ( get_option ( 'dbem_gmap_is_active' ) ) : ?>
				<div style="width: 48%; height: 300px; float:right;">
					<div id='em-map-404' style='width: 100%; height:300px; vertical-align:middle; text-align: center;'>
						<p><em><?php _e ( 'Location not found', 'dbem' ); ?></em></p>
					</div>
					<div id='em-map' style='width: 100%; height: 300px; display: none;'></div>
				</div>
				<?php endif; ?>
				<br style="clear:both; " />
			</div>
