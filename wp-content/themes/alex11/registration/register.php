<?php get_header( 'buddypress' ) ?>
	...
	<div id="content">
		<div class="padder">
			<h2>Sch&ouml;n, dass du mitmachen willst.</h2>
			<p>Willst du einen Artikel veröffentlichen? Gibt es ein Projekt, eine Veranstaltung oder sonst etwas zum Thema “Echte Demokratie Jetzt!”, das du gerne mitteilen willst? Dann veröffentliche es hier.</p>
			<p>Bevor ein Artikel freigeschaltet wird, prüfen unsere Redakteure, ob folgende Regeln eingehalten werden:</p>
			<ul class="register_enum">
