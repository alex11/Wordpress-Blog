    ...
    $widget_options = get_option('GG_func_widget_weather_and_weather_forecast');  	
      ...
      if($wun_licence_code!=""){
        if($i_location_city!="" or $i_location_state!=""){
          $wun_string = GG_func_get_content($test_wun);
        ...
        if($i_location_lat!=""){
          $wun_string = GG_func_get_content($test_wun2);
          $wun_parsed = json_decode($wun_string,true);
          $wun_test = $wun_parsed['response']['error'];
      ...
      if($fwo_licence_code!=""){
         if($i_location_city!="" or $i_location_state!=""){
            $fwo_string = GG_func_get_content($test_fwo);
        ...
        if($i_location_lat!=""){
            $fwo_string = GG_func_get_content($test_fwo2);
            $fwo_parsed = json_decode($fwo_string,true);
            $fwo_test = $fwo_parsed['data']['error'][0];
            $pos1=strpos($fwo_test['msg'],"account");
...
function GG_func_widget_weather_and_weather_forecast($args) {
  ...
  $info_text="<!--V4.0 rev003 *PID"." *ALoS".$opt_auto_location_select." *ALaS".$opt_auto_language_select." *L".$opt_language." *CSS".$opt_css_select." *Loc".$i_location_city.",".$i_location_state."*"."-->";
